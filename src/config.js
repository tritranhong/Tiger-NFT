const NFT_CONTRACT_NAME =
  process.env.NFT_CONTRACT_NAME || 'justincase2.testnet';
const MARKET_CONTRACT_NAME =
  process.env.MARKET_CONTRACT_NAME || 'justincase3.testnet';
const FT_CONTRACT_NAME = process.env.FT_CONTRACT_NAME || 'ft.vbidev.testnet';
const AUCTION_CONTRACT_NAME =
  process.env.AUCTION_CONTRACT_NAME || 'justincase.testnet';
  ...
  switch (env) {
    ...
    case 'mainnet':
      return {
        ...
        auctionContractName: AUCTION_CONTRACT_NAME,
